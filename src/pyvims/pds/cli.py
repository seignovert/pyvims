...
def cli(argv=None):
    ...
    parser.add_argument(
        '-i', '--instrument', metavar='NAME', default='VIMS', help='Instrument name.'
    )
    parser.add_argument('-p', '--prefix', default='co', help='Release prefix.')
    parser.add_argument('-s', '--src', default='jpl', help='Release source.')
    parser.add_argument('-u', '--update', action='store_true', help='Update release list')
    ...
    parser.add_argument('-f', '--fmt', default='lbl', help='Data format (LBL/QUB).')
